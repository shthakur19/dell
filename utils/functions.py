...
def nn(data, hlsizes=(1,), max_iter=10000, activ = 'relu', sol='lbfgs'):
    X = data[['zip_bins', 'bizflag', 'numords', 'dollars','last','version1','owntaxprod','sincepurch','upgraded']]
    Y_train = data[data['training'] == 1][['res1_yes']]
    X_train = data[data['training'] == 1][['zip_bins', 'bizflag', 'numords', 'dollars','last','version1','owntaxprod','sincepurch','upgraded']]
    Y_test = data[data['training'] == 0][['res1_yes']]
    X_test = data[data['training'] == 0][['zip_bins', 'bizflag', 'numords', 'dollars','last','version1','owntaxprod','sincepurch','upgraded']]
    clf = MLPClassifier(
        activation = activ,
        solver = sol,
    ...
    fig = rsm.vimp_plot_sk(clf, X_train, Y_train)
